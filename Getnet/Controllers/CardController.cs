...
namespace Getnet.Controllers
{
    ...
    {
        //Controller to make calls about the card 
        //properties
        ...
        public async Task<ActionResult> CardTokenization([FromBody]TokenCardRequest tokenCardRequest)
        {
            JsonResult data;
            try
            {
        ...
        //parameters: CardNumber and CustomerId
        public async Task<ActionResult> CardVerification([FromBody] TokenCardRequest tokenCardRequest)
        {
            JsonResult data;
            try
            {
                ...
                var response = await service.VerifyCard(tokenCardRequest);
